...
public class Menu {
    ...
    public void consultaCodigo(){
        System.out.println("\nInsira o código da máquina que você deseja buscar:");
        int codigo = sc.nextInt();
    ...
    public void alterarDados(){
        ...
        if(material != null){
            System.out.println("Insira o código do material:");
            material.setCodigo(sc.nextInt());

            sc.nextLine();
            System.out.println("Insira O título do material:");
            material.setTitulo(sc.nextLine());

            System.out.println("Insira o ano de publicação do material:");
            material.setAnoPublicacao(sc.nextInt());

            if(material instanceof Livro){
                System.out.println("Insira o autor do material:");
                ((Livro)material).setAutor()setAutor(null);
            }
        }else{
            System.out.println("\nMaterial não encontrado!");
        }
