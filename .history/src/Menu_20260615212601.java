...
public class Menu {
    ...
    public void consultaCodigo(){
        ...
        Material material = procurarMaterial(codigo);
    ...
    public void devolucao(){
        System.out.println("\nInsira o código do material que você deseja devolver:");
        int codigo = sc.nextInt();
    ...
    public void alterarDados(){
        System.out.println("\nInsira o código do material que você deseja alterar os dados:");
        int codigo = sc.nextInt();
        ...
        if(material != null){
            ...
            if(material instanceof Livro){
                ...
                sc.nextLine();
                System.out.println("\nInsira a categoria s do material:");
    ...
    public void excluirMaterial(){
        System.out.println("\nInsira o código do material que você deseja excluir:");
        int codigo = sc.nextInt();
    ...
    public void relatorio(){
        ...
        System.out.println("\nRelatório:");
        System.out.println("Quantidade total de materiais cadastrados: " + contMats);
        System.out.println("Quantidade de livros: " + contLivros);
        System.out.println("Quantidade de revistas: " + contRevistas);
        System.out.println("Quantidade de DVDs: " + contDVDs);
        System.out.println("Quantidade de materiais emprestados: " + contEmp);
        System.out.println("Quantidade de materiais diponíveis: " + contDisp);
    }

    public Material procurarMaterial(int codigo){
        for(Material material : materiais){
