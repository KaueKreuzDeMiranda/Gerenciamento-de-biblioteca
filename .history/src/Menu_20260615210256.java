...
public class Menu {
    ...
    public void consultaCodigo(){
        System.out.println("\nInsira o código da máquina que você deseja consultar:");
        int codigo = sc.nextInt();
    ...
    public void emprestimo(){
        System.out.println("\nInsira o código da máquina que você deseja emprestar:");
        int codigo = sc.nextInt();
    ...
    public void alterarDados(){
        System.out.println("\nInsira o código da máquina que você deseja alterar os da:");
        int codigo = sc.nextInt();
